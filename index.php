...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omnifood is a preminum food delivery service with the mission to bring affordable and healthy meals to as many people as possible.">
    ...
    <body>
        ...
        <section class="secion-features js--section-features" id="features">
            <div class="row">
        ...
        <section class="section-meals">
            ...
            <ul class="meals-showcase clearfix">
                ...
                <li>
                    <figure class="meal-photo">
                        <img src="resources/img/7.jpg" alt="Burger with cheddar and bacons">
                    </figure>
                </li>
                <li>
                    <figure class="meal-photo">
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                ...
                <div class="col span-1-of-4 box">
                    <img src="resources/img/london.jpg" alt="Berlin">
                    <h3>London</h3>
                    <div class="city-feature">
                        <i class="ion-ios-person icon-small"></i>
                        1200+ happy eaters
